...
3.  It is, legally, an **accountability obligation**. Under the GDPR, the controller needs to be able to demonstrate compliance; an anonymization record is the core evidence for this.
