...
-   `sdcApp()`Opens the GUI

The GUI provides a nice overview of functions. In case you decide to use it (and I recommend to try it out), create an anonymization report and the end via `export data` to make your anonymization transparent.
:::
...
1.  Create an object within sdcMicro that contains the relevant `keyVars` and `numVars`. Inspect the object.
