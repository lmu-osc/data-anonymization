...
`years_in_job` is a borderline case. It behaves like a continuous variable, but a colleague might know roughly how long someone has been in their job. Placing it in `keyVars` is a conservative choice; if you consider it less likely to be known, moving it to `numVars` is also defensible.
