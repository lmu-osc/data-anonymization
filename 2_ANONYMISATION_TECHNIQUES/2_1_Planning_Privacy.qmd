...
The goal is to use the approriate anonymization technniques to achieve an acceptable level of risk for each individual, while at the main time, keeping utility as high as possible (see also [BALANCING DATA PROTECTION AND OPENNESS](3_PRIVACY_OPENNESS/3_1_Balancing))
