...
-   **Synthesizing data** means creating new data with the same statistical properties as the original data. ![Synthetic data](../pictures/Synthetic-cropped.svg) *An example of synthetic data*
...
**Synthetic data aims to avoid disclosure risk** by generating new records based on the statistical properties of a real dataset. The records do not correspond to any real individuals but risks of statistical disclosure still needs to be assessed.<!-- the former statement was factually incorrect I believe. @Felix? -->
