...
-   **De-associative techniques** separate indirectly identifying parts of the data from the sensitive parts. ![De-associative techniques](../pictures/De-Associative-cropped.svg){fig-alt="An illustration of a de-associative technique: a data table split into an indirect-identifier part and a separate sensitive part, linked only by a group id."} *An example of a de-associative technique (i.e., anatomization)*
