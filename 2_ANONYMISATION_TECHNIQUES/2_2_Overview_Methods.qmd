...
-   **Synthesizing data** means creating new data with the same statistical properties as the original data. This method will not be discussed in detail here as it has its own dedicated tutorial: [visit the OSC tutorial on synthetic data](https://lmu-osc.github.io/synthetic-data-tutorial/). ![Synthetic data](../pictures/Synthetic-cropped.svg) *An example of synthetic data*
...
**Synthetic data aims to avoid disclosure risk** by generating new records based on the properties of a real dataset.<!-- the former statement was factually incorrect I believe. Perhaps some more expalnation is needed here. @Felix? -->
