...
Now that the key categorical variables are in their final state<!--do you mean the categorical key variables rights? income and and year in job are also key bu continuous- is it what you meant?-->, I applied **top-coding** to the key continuous variables income and years in job.
