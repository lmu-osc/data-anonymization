...
It can also happen as a result of a condition: Conditional Nulling means replacing data entries with zeros based on a condition. For example, entries in a column "Customer Feedback" could be nullified if the customer feedback was negative [@raghunathan2013complete].
...
-   basic data wrangling operations in R (better than manual changes)

-   but: when publishing anonymization script: needs to be anonymous as well (e.g., not naming specific countries)

-   tools to make this as autonomous as possible?
