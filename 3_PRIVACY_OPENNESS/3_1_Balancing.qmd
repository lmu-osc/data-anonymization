...
There are **no universal thresholds** for "good enough" privacy or utility. A commonly used rule of thumb is that k-anonymity should be at least 3-5 for most research datasets, meaning every combination of indirect identifiers appears at least 3-5 times (see [discussion above](1_FOUNDATION/1_5_Privacy_Concepts.qmd#reasonable-k)). For utility, IL1 values and eigenvalue differences close to 0 indicate low distortion. But ultimately, the right balance depends on your specific context: how sensitive is the data, who will have access, and what analyses need to be supported. When in doubt, consult your institution's data protection officer ([LMU Munich data protection office](https://www.lmu.de/en/about-lmu/structure/organizational-structure/officers-representatives-and-contact-persons/data-protection-officer.html)), data steward (or a local research data management team, or the [LMU Munich research data management team](https://www.ub.lmu.de/en/open-access-publishing/research-data/)).

<!-- COMMENT CS: Good box overall, as mentioned on prev. page, the "no magic k-value" and "reasonableness at the time" points are exactly right. Maybe mention (1) Art. 82 (right to compensation) and Art. 83 (administrative fines) so readers know what "responsibility" concretely means; both attach to the controller, supporting your institutional point. (2) A re-identification event involving released data may constitute a personal data breach with several notification duties attached (3) The accountability principle (Art. 5(2)) is the doctrinal anchor for your "documented, institutionally backed process" -> could be cited for more clarity -->
::: {.callout-note collapse="false"}
