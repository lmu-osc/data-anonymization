...
Bavaria, as a German state, has its own [Bavarian Data Protection Act (BayDSG)](https://www.datenschutz-bayern.de/datenschutzreform2018/BayDSG.pdf), which applies to public institutions - including universities like LMU. In practice, this means that researchers at Bavarian universities are subject to the GDPR, the BDSG, *and* the BayDSG.

The good news: the core principles (purpose limitation, data minimization, storage limitation) are consistent across all three. The main thing to be aware of is that your institution's data protection officer can advise you on any Bavaria-specific requirements.
:::
