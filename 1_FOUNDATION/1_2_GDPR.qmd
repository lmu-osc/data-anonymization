...
The General Data Protection Regulation (GDPR), in German "Datenschutz-Grundverordnung" (DSGVO), is the **central legal framework** for the protection of personal data in the **European Union**. <!-- COMMENT CS: Precision: the GDPR was adopted in 2016 and *applies* since 25 May 2018 (Art. 99(2)). "Came into force" is a littlbe bit vague. Also, GDPR was adopted by the EWR (No+Ice+Li) and with Brexit, they simply kept it (but now it starts to diverge). -->
It came into force in 2018 and applies to anyone who processes personal data of individuals in the EU and in Norway, Liechtenstein, and Iceland. In general, it also applies to researchers and universities, regardless of where they are based [@jarmul2023].
...
Any information relating to an identified or identifiable natural person. This includes obvious identifiers like names and email addresses, but also indirect identifiers like age, postal code, or job title, if they can be combined to single out an individual. See [the next chapter](1_3_Personal_Data) for a detailed explanation.
...
<!-- COMMENT CS: Legally, the controller is almost always the *institution* (university), not the individual PI. Researchers rarely qualify as controllers in their own right within an employment relationship. See also 3_1_Balancing. I would state the institution as controller and note the PI's operational responsibility. Also missing: joint controllership (Art. 26) for multi-site/collaborative studies, which is a common stumbling block in research consortia. -->
...
**Legal basis for processing.** You need a legal basis to process personal data. <!-- COMMENT CS: (1) Art. 6(1)(e) and (f) are distinct and should not be slashed together: I doubt that legitimate interest (f) is  available to public universities for tasks carried out in the exercise of official authority. General note: consent under Art. 6(1)(a) is fragile in research: it must be freely given (Art. 7(4)), which is doubtful in asymmetric settings (student–lecturer, patient–physician). Maybe worth a sentence. Also, Art. 6 - Articlne 9(2)(j) (research) interplay may be worth mentioning here. -->
In research, this is usually either *informed consent* (Art. 6(1)(a)) or *legitimate interest / public interest* (Art. 6(1)(e/f)). The GDPR sets strict requirements for what information participants must receive before giving consent (Art. 13/14): the purpose of processing, who will have access, how long data will be stored, and what rights participants have. I discuss informed consent further in [the chapter on mechanisms of data protection](1_4_Mechanisms).
...
**Data minimization.** You should only collect data that is necessary for your research purpose. Collecting "nice-to-have" demographics without a clear reason is not just bad practice—it may also be a GDPR issue. We discuss this more in [the chapter on mechanisms of data protection](1_4_Mechanisms).
...
<!-- COMMENT CS: I am not 100% sure what you are trying to say here, but the purpose-compatibility presumption for research is Art. 5(1)(b), not Art. 89. Art. 89 is primarily a safeguards provision. Therefore, I think that calling Art. 89 an "exemption" is misleading -->
...
<!-- COMMENT CS: It could be worthwhile to mention that anonymization is itself a *processing operation* requiring a legal basis --> one cannot anonymize personal data "to escape" the GDPR; -->
...
But be careful: **pseudonymized** data (e.g., replacing names with codes while keeping a key file) is still personal data under the GDPR. The regulation explicitly states this. We cover the distinction between anonymization and pseudonymization in [the chapter on mechanisms of data protection](1_4_Mechanisms).
:::
...
<!-- COMMENT CS: Note: I feel that the blanket phrase "research in the public interest" overstates the exception. Could be worth adding the right to restriction (Art. 18) and the Art. 19 notification duty, both highly relevant when data has already been shared. -->
