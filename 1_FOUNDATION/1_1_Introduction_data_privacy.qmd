...
Nothing was "leaked" in a traditional sense. The information flowed - but it violated the norms of the context in which it was shared. This is exactly what Nissenbaum's framework captures: Privacy means that contextual information norms are respected in all information flows.
...
The information type and sender haven't changed, but the recipient and transmission principle have. The contextual norm is violated. This is a privacy violation not because a name was exposed, but because information flowed in a way that didn't match the norms of the context in which it was shared. And in turn, this lead to the disclosure of an individual's identity as well as sensitive information about them and their work life.
:::
...
Next to data protection laws, there are other legal reasons for not-sharing information. To name the two most important ones: Intellectual property interests and export controls.

*Add: relevant laws in Germany regarding IP and export controls, when is this relevant for researchers; contact your institution's legal support in case of questions*
