...
![Research Process and Mechanisms](../pictures/Mechanisms-cropped.svg){fig-alt="FIXME"}<!-- add alt-text describing the figure? + add TOMs in legend as we haven't encountered that term yet)-->
...
A useful template for DMPs is available on [Zenodo](https://zenodo.org/records/10782781).<!-- is this really a DMP? it seems like a anonymization plan for qualitative research; specify this?-->
...
The key point: **pseudonymized data is still personal data.** The GDPR explicitly states that "personal data which have undergone pseudonymisation, which could be attributed to a natural person by the use of additional information should be considered to be information on an identifiable natural person" (Recital 26)<!--oh is this a paragraph in the gdpr text? make cleaer, hyperlink to gdpr text?-->. As long as a key file exists that links participant codes back to real identities - or as long as indirect identifiers in the data could allow re-identification - the data remains personal, and the GDPR fully applies.
