...
3.  **Privacy embedded into design:** Privacy should be an integral part of your research design, not an add-on. Plan your data collection, storage, and sharing with privacy in mind from the start.

4.  **Full functionality - positive-sum, not zero-sum:** Privacy and data utility are not opposites. The goal is to find approaches that serve both - enabling meaningful research while protecting individuals.
