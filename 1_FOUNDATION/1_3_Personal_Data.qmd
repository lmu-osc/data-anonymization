...
Additional sensitive data include<!--how are they different from the above?-->:
...
Delete the old file.<!--mmhh that info is needed for something otherwise why was it collected? minimally the name is needed to withdraw people's data if request it; and email if you detect a disease and need to inform them @Felix?-->
:::
