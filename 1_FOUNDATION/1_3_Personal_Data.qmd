...
::: {#optimal-workflow .callout-tip collapse="false"}
...
3.  **Remove the pseudonym key** using the same logic. If either direct identifiers or a pseudonym key would serve the purpose, keep the key—it is the safer option—but store it *separately* from the data, with restricted access and a defined deletion date.
