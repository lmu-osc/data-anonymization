...
<!-- COMMENT CS: The chapter says "sensitive = handle carefully" but omits the legal consequence: processing Art. 9 data is *prohibited by default* (Art. 9(1)) unless an Art. 9(2) exception applies; prob.  Art. 9(2)(j) in conjunction with Art. 89(1) iA. This prohibition-plus-exception logic is structurally different from Art. 6. Could also be worth noting that Art. 9 data processing could trigger a DPIA. -->
