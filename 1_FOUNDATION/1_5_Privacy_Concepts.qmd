...
We will use k-anonymity practically in the [next part](../2_ANONYMISATION_TECHNIQUES/2_1_Planning_Privacy.qmd) of this tutorial, where we calculate it using R and the `sdcMicro` package.
