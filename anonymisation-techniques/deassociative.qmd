...
Anatomization is a cleaner alternative to bucketization that improves the properties of the resulting deassociation \[ @xiao2006\]. Rather than shuffling values within buckets, anatomization splits the dataset into two separate tables:
