...
These data are treated differently by GDPR: By default, their processing is prohibited ([Art. 9(1)](https://eur-lex.europa.eu/eli/reg/2016/679/oj/eng#art_9)), and only allowed, when an exemption applies—for example, when processing is necessary for scientific purposes ([Art. 9(2)(j)](https://eur-lex.europa.eu/eli/reg/2016/679/oj/eng#art_9)) and special safeguards are in place (see [the chapter on mechanisms of data protection](mechanisms.qmd)).
