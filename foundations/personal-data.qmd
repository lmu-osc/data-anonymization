...
**Information on criminal convictions and offences** is a special case. Under [Art. 10](https://eur-lex.europa.eu/eli/reg/2016/679/oj/eng#art_10) GDPR, such data may only be processed under the control of an official authority. The GDPR leaves room for national exemptions, but Germany (and e.g., Bavaria) has not created a clear, general basis for processing this data in research. If your work requires collecting data on criminal convictions, I recommend talking to your institution's data protection officer.
