...
These data are treated differently by GDPR: By default, their processing is prohibited (Art. 9(1)), and, only when an exemption applies, allowed—for example, when processing is necessary for scientific purposes (Art. 9(2)(j)) and special safeguards are in place (see [the chapter on mechanisms of data protection](mechanisms.qmd)).
